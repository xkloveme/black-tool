<!--
 * @Date: 2023-09-19
 * @LastEditTime: 2023-09-26 22:57:47
...
let qr = ref('')
let newQr = computed(() => `https://mapi.zjzwfw.gov.cn/web/mgop/gov-open/zj/2002271810/lastTest/index.html?debug=true#/pages/test/index?url=${qr.value}`)
</script>
